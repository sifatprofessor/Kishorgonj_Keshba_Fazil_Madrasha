...
const Gallery: React.FC = () => {
    ...
    return (
        <>
            ...
            {loadingIndicator}
            {data.length > 0 ? (
                <Card className="w-full overflow-scroll Navbar" shadow={false} color="transparent" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
